...
export default function LookReviewDetailPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-10">
      <Link href="/system/look-reviews" className="text-sm text-gray-500 hover:text-gray-700 mb-6 inline-flex items-center gap-1">
